    ...
    <form className="w-full px-6 flex items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 h-20">
      ...
      {searchParams.get('filter') && (
        <button
          ...
          className="rounded-xl bg-zinc 400 font-semibold px-3 py-2 transition duration-300 ease-in-out hover:-translate-y-1"
        >
          Clear Filters
        </button>
      )}
      ...
      <UserCircle
            className="h-14 w-14 transition duration-300 ease-in-out hover:scale-110 hover:border-2 hover:border-zinc-400"
            profile={profile}
